...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            /*
            * Create initial data and, if database is empty, it will be persisted into Postgres
            * */
            ...
            log.error("Data seeder: Could not possible to persist initial data into DB");
